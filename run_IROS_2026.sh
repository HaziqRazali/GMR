...
python scripts/smplx_to_robot.py \
  ...
  --robot unitree_h1 --rate_limit --record_video --camera_distance 5.5 --camera_elevation -15 --camera_height 1 --rotate_yaw -90 \
...
python scripts/smplx_to_robot.py \
  --smplx_file /home/haziq/datasets/mocap/data/fit3d/train/s04/smplx/warmup_9.json \
  --robot unitree_h1 --rate_limit --record_video --camera_distance 5.5 --camera_elevation -15 --camera_height 1 --rotate_yaw -90 \
  --save_path unitree_h1_warmup_9_true.npz \
  --video_path videos/unitree_h1_warmup_9_true.mp4 \
...
python scripts/smplx_to_robot.py \
  ...
  --robot unitree_h1 --rate_limit --record_video --camera_distance 5.5 --camera_elevation -15 --camera_height 1 --rotate_yaw -90 \
  --save_path unitree_h1_bicep_curl_generated.npz \
  --video_path videos/unitree_h1_bicep_curl_generated.mp4 \
  --ik_config general_motion_retargeting/ik_configs/smplx_to_h1_generated.json
  
python scripts/smplx_to_robot.py \
  --smplx_file /home/haziq/datasets/mocap/data/fit3d/train/s04/smplx/dumbbell_biceps_curls.json \
  --robot unitree_h1 --rate_limit --record_video --camera_distance 5.5 --camera_elevation -15 --camera_height 1 --rotate_yaw -90 \
  --save_path unitree_h1_bicep_curl_true.npz \
  --video_path videos/unitree_h1_bicep_curl_true.mp4 \
  --ik_config general_motion_retargeting/ik_configs/smplx_to_h1.json
...
python scripts/smplx_to_robot.py \
  --smplx_file /home/haziq/datasets/mocap/data/fit3d/train/s04/smplx/warmup_9.json \
  --robot openloong --rate_limit --record_video --camera_distance 5.5 --camera_elevation -15 --rotate_yaw -90 \
  --save_path openloong_warmup_9_true.npz \
  --video_path videos/openloong_warmup_9_true.mp4 \
...
python3 scripts/generate_smplx_retarget.py \
  ...
  --approx-arms \
  --no-hip-anatomy \
  -o general_motion_retargeting/ik_configs/smplx_to_tienkung_generated.json
...
python3 scripts/generate_smplx_retarget.py \
assets/unitree_g1/g1_custom_collision_29dof.urdf \
--human-scale 0.9 \
--arm-scale 0.8 \
--ground-height 0.0 \
--no-head \
-o general_motion_retargeting/ik_configs/smplx_to_g1_generated.json
...
python scripts/smplx_to_robot_v2.py idx=215 result_foldername="/home/haziq/Collab_AI/results/AAAI2026/2024_11_18/gimo/obj2pose/cvae=all_v2_transl=mse_orient=mse_pred_all_objects_dtype=val_seminar_room1_0221_2022-02-21-014246_mib/" obj_idx=6 rep_idx=0 --robot unitree_g1 --save_path objidxxxx_repidx0.npz --rate_limit
python scripts/export_robot_motion_to_blender.py --motion_file objidxxxx_repidx0.npz --robot unitree_g1 --output blender_export/objidxxxx_repidx0/robot_motion.fbx