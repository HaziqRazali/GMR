...
ROBOT_XML_DICT = {
    ...
    "booster_t1_29dof_posonly": ASSET_ROOT / "booster_t1_29dof" / "t1_mocap.xml",
...
IK_CONFIG_DICT = {
    ...
    "smplx":{
        ...
        "booster_t1_29dof_posonly": IK_CONFIG_ROOT / "smplx_to_t1_29dof_posonly.json",
...
ROBOT_BASE_DICT = {
    ...
    "booster_t1_29dof_posonly": "Waist",
